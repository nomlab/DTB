...
Dir::chdir("c:/Users/Fukuda/Dropbox/DTBの評価/files"){
 ...
 bm = Bookmark.find_by_name "ディベートの準備(テーマ案の募集)"
  h = FileHistory.create(:path => dir+"\\ディベート\\ディベートのテーマ案募集.txt",
                        :title => "ディベートのテーマ案募集.txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  ...
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成1\\研修会のしおりについて.txt",
                         :title => "研修会のしおりについて.txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成1\\2012年度研修会のしおり.doc",
                         :title => "2012年度研修会のしおり.doc")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成1\\2012年度研修会のしおり.pdf",
                         :title => "2012年度研修会のしおり.pdf")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  
  
  bm = Bookmark.find_by_name "しおりの草案作成2"
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成2\\研修会のしおり(案2)について.txt",
                         :title => "研修会のしおり(案2)について.txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成2\\2012年度研修会のしおり(案2).doc",
                         :title => "2012年度研修会のしおり(案2).doc")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成2\\2012年度研修会のしおり(案2).pdf",
                         :title => "2012年度研修会のしおり(案2).pdf")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  
  
  bm = Bookmark.find_by_name "しおり草案修正"
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成3\\研修会のしおり(案3)について.txt",
                         :title => "研修会のしおり(案3)について.txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成3\\2012年度研修会のしおり(案3).doc",
                         :title => "2012年度研修会のしおり(案3).doc")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成3\\2012年度研修会のしおり(案3).pdf",
                         :title => "2012年度研修会のしおり(案3).pdf")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  

  bm = Bookmark.find_by_name "しおり草案修正2"
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成4\\",
                         :title => "")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  
  
  bm = Bookmark.find_by_name "しおりの修正(ディベートについて)"
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成4\\研修会のしおり(案4)について.txt",
                       :title => "研修会のしおり(案4)について.txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成4\\2012年度研修会のしおり(案4).doc",
                       :title => "2012年度研修会のしおり(案4).doc")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成4\\2012年度研修会のしおり(案4).pdf",
                       :title => "2012年度研修会のしおり(案4).pdf")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  

  bm = Bookmark.find_by_name "しおりの修正(部屋割り，必要機材)"
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成5\\2012年度研修会のしおり(8月7日).txt",
                        :title => "2012年度研修会のしおり(8月7日).txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成5\\2012年度研修会のしおり-20120807.doc",
                        :title => "2012年度研修会のしおり-20120807.doc")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  

  bm = Bookmark.find_by_name "しおりの修正(旅程)"
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成6\\2012年度研修会のしおり(8月21日).txt",
                        :title => "2012年度研修会のしおり(8月21日).txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成6\\2012年度研修会のしおり-20120821.doc",
  ...
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成7\\2012年度研修会のしおり(8月23日).txt",
                        :title => "2012年度研修会のしおり(8月23日).txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成7\\2012年度研修会のしおり-20120823.doc",
                        :title => "2012年度研修会のしおり-20120823.doc")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  

  bm = Bookmark.find_by_name "しおりの修正(旅程，研修内容)"
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成8\\2012年度研修会のしおり(8月24日).txt",
                        :title => "2012年度研修会のしおり(8月24日).txt")
  Timeline.create(:bookmark_id => bm.id, :history_id => h.id)
  h = FileHistory.create(:path => dir+"\\しおりの作成\\しおりの作成8\\2012年度研修会のしおり-20120824.doc",
